classdef S_Race < handle
% S_Race class

% COPYRIGHT
%  (C) 2013 Tiantian Zhang, Machine Learning Lab, University of Central Florida
...
% T. Zhang, M. Georgiopoulos, G. C. Anagnostopoulos, "S-Race: A Multi-objective Racing Algorithm", GECCO 2013
    ...
    methods
        ...
        % Constructor
        function obj = S_Race(M, Max_step, Delta, batch_size)
            if nargin == 4
                obj.M = M;
                obj.currentM = 1:M;
                ...
                obj.alpha = (1 - Delta)/(M - 1)/(Max_step - 1);
                obj.iniM = M;
